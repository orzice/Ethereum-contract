...
/**
 *Submitted for verification at hecoinfo.com on 2021-04-14
*/
...
/**
    ...
    特点:
    交易有10%的手续费
    每笔交易的5%手续费自动分配给所有#NIUB持有者,经典的持有即挖矿
    每笔交易的5%手续费合约自动添加到流动性,并且锁定,完美的资金池自我成长性
    总供应量的50%会燃烧到黑洞地址
    
    安全性:
    总供应量的49%会和 1HT 配比添加到流动性,并且立刻燃烧掉所有流动性LP,已达到流动性100%锁定永久
    合约拥有权ownership将转移至黑洞地址(0x000000000000000000000000000000000000dead),这样#NIUB将完全社区化
    以上两点将保证#NIUB 100%的安全性和社区化
...
contract HUCToken is Context, IERC20, Ownable {
    ...
    string private _name = "babyToken";
    ...
    uint256 private numTokensSellToAddToLiquidity = 200000 * 10**6 * 10**18;
